...
flowchart TB
    ...
    subgraph Core["Core (TypeScript puro)"]
        ...
        Portas["Portas<br/>(decisores de jogador)"]
...
- Bots são adapters de jogador automatizado, injetados no core pelas portas de decisão.
- O core define o contrato de decisão, mas não contém algoritmos específicos de bot.
- Algoritmos de bot vivem em `src/adapters/bots/`, incluindo heurística, árvore de decisão e temperatura.
