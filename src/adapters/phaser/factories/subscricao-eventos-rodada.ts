...
export interface CallbacksRodada {
  ...
  onPontuacaoAplicada?: (placar: Record<string, number>, penalidades: Record<string, number>) => void;
...
export function subscreverEventos(emissor: ReturnType<typeof createEmissorEventos>, callbacks: CallbacksRodada): void {
  ...
  emissor.on('PONTUACAO_APLICADA', (evento) => callbacks.onPontuacaoAplicada?.(evento.placar, evento.penalidades));
